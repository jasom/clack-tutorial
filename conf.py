...
BLOG_AUTHOR = "Jason Miller"  # (translatable)
BLOG_TITLE = "Clack Tutorial"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jasom.github.io/clack-tutorial/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jasom.github.io/clack-tutorial/"
BLOG_EMAIL = "jasom@fastmail.com"
BLOG_DESCRIPTION = "Tutorial for clack web library"  # (translatable)
